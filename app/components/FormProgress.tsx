  ...
  return (
    <div className="w-full mt-9 mb-20 flex gap-2 rounded">
      <div className="w-full flex flex-col gap-3 items-center">
        <div
          className={`w-full h-[10px] ${
            page >= 1 ? "bg-green-500" : "bg-slate-200"
          } rounded-full`}
        ></div>
      ...
      <div className="w-full flex flex-col gap-3 items-center">
        <div
          className={`w-full h-[10px] ${
            page >= 2 ? "bg-green-500" : "bg-slate-200"
          } rounded-full`}
        ></div>
      ...
      <div className="w-full flex flex-col gap-3 items-center">
        <div
          className={`w-full h-[10px] ${
            page >= 3 ? "bg-green-500" : "bg-slate-200"
          } rounded-full`}
        ></div>
      ...
      <div className="w-full flex flex-col gap-3 items-center">
        <div
          className={`w-full h-[10px] ${
            page >= 4 ? "bg-green-500" : "bg-slate-200"
          } rounded-full`}
        ></div>
        <p className="text-md font-medium">Acknowledgement</p>
      </div>
    </div>
  );
}
